...
\begin{frame}{Distributed design}
  \only<1>{\includegraphics[width=1.0\textwidth]{images/distributed1}}
  \only<2>{\includegraphics[width=1.0\textwidth]{images/distributed2}}
  \only<3>{\includegraphics[width=1.0\textwidth]{images/distributed3}}
  \only<4>{\includegraphics[width=1.0\textwidth]{images/distributed4}}
\end{frame}
...
\begin{frame}{Time and Memory Complexity}
  \begin{itemize}
    \only<1-2>{\item \textbf{Learning algorithm} is faster to predict, but...}
    \only<2>{\item \textbf{precomputation} required is long and \textbf{memory space} used is large!}
  \end{itemize}
\end{frame}
